            ...
            <div class="mostrar">
              <table style="width:100%" id="carro" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
                  ...
                  <tbody>
                      ...
                      $result=mysqli_query($con,"SELECT * FROM `servicios` WHERE id > 1 AND estatus='proceso'");
                      while($row=mysqli_fetch_array($result)){
                          ...
                          <tr>
                              ...
                              <td><form action="modificacion.php?action=update_service" method="post">
                              ...
                              <td>
                                <form action="detalles_servicio2.php" method="post">
                                  <input type="hidden" value="<?php echo $row["id"]; ?>" name="id">
